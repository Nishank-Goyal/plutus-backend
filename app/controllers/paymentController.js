...
paymentController.acceptPayment = async (payload) => {
  ...
  if (!payload.transactionID) {
    ...
    if (paymentData) {
      return Object.assign(HELPERS.responseHelper.createSuccessResponse(MESSAGES.PAYMENT_FOUND), { isTransactionFound: true, data: paymentData,walletData });
    }
    return Object.assign(HELPERS.responseHelper.createSuccessResponse(MESSAGES.NOT_FOUND), { isTransactionFound: false ,walletData});
  }
